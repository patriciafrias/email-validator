...
use EmailValidator\Infrastructure\Adapter\Doctrine\Domain\EmailValidationIdType;
...
return [
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'namespaces'    => [
                'EmailValidator\Domain\Entity'
            ],
            'paths'         => [
                base_path('src/Domain/Entity')
            ],
    ...
    */
    'custom_types'               => [
        ...
        'EmailValidationId' => EmailValidationIdType::class,
    ],
    /*
    |--------------------------------------------------------------------------
